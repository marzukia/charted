...
class LineRenderer:
    ...
    def _get_series_style(self, index: int) -> dict:
        ...
        base_style = self.chart.theme.get("series_style") or {}
    ...
    def _get_marker(
        ...
        if marker_shape == "square":
            ...
            return Circle(cx=x, cy=y, r=marker_size)
    ...
    def _create_area_path(
        ...
        last_x = x_values[-1] + self.chart.x_offset
        last_y = y_values[-1] if y_values else 0
        first_x = x_values[0] + self.chart.x_offset
