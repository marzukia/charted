...
def images_to_arrays(image1: 'Image.Image', image2: 'Image.Image') -> Tuple['np.ndarray', 'np.ndarray']:
...
def render_chart_to_png(chart, width: int = 800, height: int = 600) -> 'Image.Image':
    """
