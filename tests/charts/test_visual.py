...
def test_column_chart_basic():
    """Visual regression test for basic ColumnChart."""
...
def test_line_chart_basic():
    """Visual regression test for basic LineChart."""
...
def test_scatter_chart_basic():
    """Visual regression test for basic ScatterChart."""
...
def test_column_chart_stacked():
    """Visual regression test for stacked ColumnChart."""
    chart = ColumnChart(
        data=[[1, 2, 3], [2, 3, 4]],
        labels=["a", "b", "c"],
    )
...
def test_line_chart_multi_series():
    """Visual regression test for multi-series LineChart."""
    chart = LineChart(
        data=[[1, 2, 3], [3, 2, 1]],
        labels=["a", "b", "c"],
...
def test_scatter_chart_multi_series():
    """Visual regression test for multi-series ScatterChart."""
    chart = ScatterChart(
        x_data=[[1, 2, 3], [2, 3, 4]],
        y_data=[[1, 2, 3], [3, 2, 1]],
    )
